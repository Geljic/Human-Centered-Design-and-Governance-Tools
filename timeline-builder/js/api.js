...
// Adapted from Persona Builder for Timeline Builder
// ============================================================

const LS_ENDPOINT = 'timeline_api_endpoint';
const LS_KEY      = 'timeline_api_key';
const LS_MODEL    = 'timeline_api_model';
...
async function chatCompletion(messages, options) {
  const endpoint = getEndpoint();
  if (!endpoint) throw new Error('API endpoint not configured. Open AI Settings above.');
